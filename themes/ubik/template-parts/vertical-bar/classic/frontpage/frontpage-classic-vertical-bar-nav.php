<?php
/**
 * Front page classic vertical bar navigation template part.
 *
...
$nav_style = get_theme_mod('ubik_frontpage_classic_vertical_bar_nav_style', 'accordion');
...
if ( has_nav_menu( 'vertical_bar_nav' ) ) :
  ...
  // Menu arguments
	...
	<nav class="frontpage-classic-vertical-bar-nav <?php echo esc_attr( ubik_frontpage_classic_vertical_bar_nav_classes() ); ?>" <?php ubik_schema_markup( 'site_navigation' ); ?>>
