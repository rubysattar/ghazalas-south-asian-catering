<?php
/**
 * Front page menu bar navigation template part.
 *
...
if ( has_nav_menu( 'header_menu_bar_nav' ) ) :
  ...
  // Menu arguments
	$menu_args = array(
		'theme_location' => 'header_menu_bar_nav',
	...
	<nav class="frontpage-menu-bar-nav <?php echo esc_attr( ubik_frontpage_menubar_nav_classes() ); ?>" <?php ubik_schema_markup( 'site_navigation' ); ?>>
